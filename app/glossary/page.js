...
const terms = [
  ...
  {
    term: "All Is Lost",
    definition: "The lowest point of a story. Everything the protagonist has been working toward is destroyed or revealed as impossible. Something must die here, literal or symbolic. The All Is Lost moment must be earned through escalation. It is not a setback; it is the bottom.",
    related: ["Dark Night of the Soul", "Act Breaks", "Save the Cat"],
  },
  {
    term: "Dark Night of the Soul",
    definition: "The emotional aftermath of the All Is Lost moment. The protagonist processes their lowest point and, from within it, finds the will or insight to attempt a final solution. Nothing external drives the Dark Night —the protagonist is alone with their failure. The solution must come from within them, not from coincidence.",
    related: ["All Is Lost", "Character Arc", "Ghost"],
  },
  {
    term: "Denouement",
    definition: "From the French, meaning untying. The final section of a story following the climax —where the conflict is settled, characters reach their new states, and the world comes to rest. It should be brief: what has not been resolved by the climax will not be resolved in the denouement.",
    related: ["Climax", "Resolution", "Story Structure"],
  },
  {
    term: "Hook (opening)",
    definition: "The opening image, scene, or line that establishes the world, tone, and stakes of the story. A strong hook creates an immediate question in the reader —not necessarily a plot question, but a question about the world or the character. In the Seven-Point Structure, the Hook is the starting state —the mirror opposite of the Resolution.",
    related: ["Opening Image", "Inciting Incident", "Seven-Point Structure"],
  },
  {
    term: "Identity vs. Essence",
    definition: "In Michael Hauge's Six-Stage Structure, Identity is the false self a character hides behind —the persona constructed to protect against their wound. Essence is the true self underneath. The outer journey forces the character to shed their Identity and act from their Essence. The distance between who a character pretends to be and who they are is where the story's emotional power lives.",
    related: ["Character Arc", "Ghost", "Story Structure"],
  },
  {
    term: "Midpoint",
    definition: "The scene or event at the exact center of a story —roughly page 55 of a 110-page screenplay —where the protagonist shifts from reacting to actively pursuing. In Save the Cat, the midpoint is a False Victory or False Defeat. After the midpoint, the protagonist is no longer passive. A weak midpoint is one of the most common structural failures in first drafts.",
    related: ["Act Breaks", "Save the Cat", "Story Structure"],
  },
  {
    term: "Negative Arc",
    definition: "A character arc in which the protagonist moves toward a worse version of themselves over the course of the story. Not a failed positive arc but one in which each choice progressively narrows the character's humanity. Daniel Plainview in There Will Be Blood. Amy Dunne in Gone Girl. The negative arc requires the reader to believe each step toward destruction was the character's genuine choice.",
    related: ["Character Arc", "Ghost", "The Lie"],
  },
  {
    term: "Pinch Point",
    definition: "In the Seven-Point Structure, a scene that demonstrates the power of the antagonistic force —not a plot turn, but a demonstration. Pinch Point 1 shows the threat. Pinch Point 2 delivers it at its strongest. The Pinch Points give the antagonist a structural role: not just obstacles but reminders of what is at stake.",
    related: ["Antagonist", "Seven-Point Structure", "All Is Lost"],
  },
  {
    term: "Pitch",
    definition: "A concise, persuasive summary of a story designed to sell it to a producer, agent, or editor. A pitch creates excitement rather than comprehension. A logline is a one-sentence pitch. A treatment is a longer written pitch. The elevator pitch is the ninety-second version.",
    related: ["Logline", "Treatment", "Query Letter"],
  },
  {
    term: "Plot Turn",
    definition: "In the Seven-Point Structure, a major event that changes the direction of the story. Plot Turn 1 (the inciting incident) pulls the protagonist into the unfamiliar. Plot Turn 2 gives the protagonist the insight or tool needed to resolve the story —and must emerge from their internal transformation, not external luck.",
    related: ["Inciting Incident", "Seven-Point Structure", "Act Breaks"],
  },
  {
    term: "Resolution",
    definition: "The conclusion of a story's central conflict —what happens after the climax. In the Seven-Point Structure, the Resolution is written first, defining who the protagonist is at the end. Resolution is distinct from Denouement: the Resolution is the outcome; the Denouement is the aftermath that confirms it.",
    related: ["Climax", "Denouement", "Story Structure"],
  },
  {
    term: "Scene Description",
    definition: "The action lines in a screenplay —present tense prose describing what the camera sees and what characters do. Scene description should be active, visual, and specific. It should never describe interior states the camera cannot capture, and should avoid directing the camera. Good scene description creates a vivid mental image in the minimum number of words.",
    related: ["Screenplay Format", "Show vs. Tell", "Action Lines"],
  },
  {
    term: "Snowflake Method",
    definition: "A novel-plotting technique by Randy Ingermanson. Expand the story outward from a single core sentence: one sentence becomes a paragraph, becomes character summaries, becomes a full scene list. Designed for plotters writing complex genre fiction who need structural clarity before drafting. Steps 1 through 3 are enough to begin writing.",
    related: ["Outline", "Story Structure", "Character"],
  },
  {
    term: "Voice (authorial)",
    definition: "The recognizable quality of a writer's prose that makes their work identifiable —the accumulation of word choice, rhythm, tone, subject matter, and perspective that is uniquely theirs. Voice is not style but the personality that style expresses. Elmore Leonard's voice is laconic and darkly funny. Toni Morrison's is layered, mythic, and rhythmically precise. Voice develops over years of writing and reading.",
...
export default function GlossaryPage() {
  ...
  return (
    <div style={{ background: 'var(--off-white)', minHeight: '100vh' }}>
      ...
      <section style={{ background: 'linear-gradient(160deg, #2D5016 0%, var(--green) 55%, #4a8a24 100%)', padding: '72px 24px 60px' }}>
