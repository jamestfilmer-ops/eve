...
export default function Skeleton({ variant = 'line', width, height, lines = 3, style = {} }) {
  return (
    <>
      ...
      {variant === 'card' && (
        <div style={{ background: '#fff', border: '1px solid #C8DCCA', borderRadius: '14px', padding: '22px', display: 'flex', flexDirection: 'column', gap: '12px', ...style }}>
          <style>{STYLE_TAG}</style>
      ...
      {variant === 'stat' && (
        <div style={{ background: '#fff', border: '1px solid #C8DCCA', borderRadius: '14px', padding: '18px 20px', textAlign: 'center', ...style }}>
          <style>{STYLE_TAG}</style>
      ...
      {variant === 'idea' && (
        <div style={{ background: '#fff', border: '1px solid #C8DCCA', borderRadius: '12px', padding: '18px 20px', display: 'flex', gap: '14px', ...style }}>
          <style>{STYLE_TAG}</style>
          <div style={{ flex: 1, display: 'flex', flexDirection: 'column', gap: '8px' }}>
