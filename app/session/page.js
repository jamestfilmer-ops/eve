        ...
        {!revealed ? (
          <div>
            ...
            <button
              ...
              style={{ background: 'linear-gradient(160deg, #a07010 0%, var(--green) 55%, #c08010 100%)', color: '#fff', border: 'none', borderRadius: '7px', padding: '9px 18px', fontSize: '13px', fontFamily: 'var(--font-ui)', fontWeight: '600', cursor: 'pointer' }}
            >
              Reveal prompt
            </button>
          </div>
