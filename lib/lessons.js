// lib/lessons.js — single source of truth for the lesson catalog
// Both app/learn/page.js and app/sitemap.js import from here.
...
export const LESSONS = [
  ...
  },
  {
    ...
    items: [
      ...
      { title: 'Where to submit short fiction', slug: 'short-story-markets', time: '6 min', level: 'Intermediate', preview: 'The New Yorker, Ploughshares, SmokeLong — 19 serious literary markets with direct submission links and honest notes on what each one actually wants.' },
      { title: 'Where to publish genre fiction', slug: 'genre-fiction-markets', time: '8 min', level: 'Intermediate', preview: 'Clarkesworld, Tor.com, Beneath Ceaseless Skies, Strange Horizons — the SF, fantasy, and horror markets that define the field, from SFWA-qualifying pro rates to semi-pro venues.' },
      { title: 'How to write a cover letter', slug: 'how-to-write-a-cover-letter', time: '5 min', level: 'Beginner', preview: 'The cover letter for a magazine submission is four sentences. Not a pitch, not a summary — an introduction. Here is exactly what to write and what to leave out.' },
  ...
  },
  {
    ...
    items: [
      ...
      { title: 'Stakes', slug: 'stakes', time: '7 min', level: 'Beginner', preview: 'Stakes are not explosions or death threats. They are the cost of failure. Getting them right is the difference between grip and slide.' },
      ...
      { title: 'Escalation: how stories raise the pressure', slug: 'escalation', time: '6 min', level: 'Intermediate', preview: 'Adding a bigger explosion is not escalation. It is spectacle. Escalation means each new obstacle costs the character something they cannot replace.' },
      { title: 'Misdirection: how to mislead without cheating', slug: 'misdirection', time: '7 min', level: 'Intermediate', preview: 'Misdirection is a structural commitment to two truths simultaneously — one visible, one hidden. The difference between a twist and a cheat is whether the truth was always in the story.' },
      { title: 'The reveal: how to earn a disclosure', slug: 'the-reveal', time: '7 min', level: 'Intermediate', preview: 'A reveal changes the meaning of what already happened, not just what comes next. The retroactive effect is what separates revelation from exposition.' },
    ],
  },
  {
    ...
    items: [
      ...
      { title: 'Dramatic irony: the secret the audience keeps', slug: 'dramatic-irony', time: '7 min', level: 'Intermediate', preview: 'Dramatic irony occurs when the audience knows something a character doesn\'t. It weaponizes empathy — we know the danger, they don\'t, and we can\'t intervene.' },
    ],
  },
  {
    category: 'Character',
...
export const WRITTEN_SLUGS = [
  ...
  'location-as-character', 'scene-endings', 'dramatic-irony',
  'escalation', 'misdirection', 'the-reveal',
  'short-story-craft', 'short-story-markets', 'flash-fiction',
  'genre-fiction-markets', 'how-to-write-a-cover-letter',
...
// Flat list of every slug across all categories
export const ALL_SLUGS = LESSONS.flatMap(cat => cat.items.map(i => i.slug))

// Only slugs that currently resolve to real pages (for sitemap)
export const PUBLISHED_SLUGS = ALL_SLUGS.filter(slug => WRITTEN_SLUGS.includes(slug))
