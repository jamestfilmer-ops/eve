...
export function ShotScaleDiagram() {
  const shots = [
    { label: 'EWS', name: 'Extreme Wide', fill: '#e8f5e9', stroke: '#4A8C8C' },
    { label: 'WS',  name: 'Wide Shot',   fill: '#c8e6c9', stroke: '#4A8C8C' },
    { label: 'MS',  name: 'Mid Shot',    fill: '#a5d6a7', stroke: '#4A8C8C' },
    { label: 'MCU', name: 'Med Close',   fill: '#81c784', stroke: '#4A8C8C' },
    { label: 'CU',  name: 'Close-Up',    fill: '#66bb6a', stroke: '#4A8C8C' },
      ...
      <svg viewBox="0 0 700 180" xmlns="http://www.w3.org/2000/svg" style={{ width: '100%', height: 'auto', display: 'block' }}>
        {shots.map((shot, i) => {
          ...
          return (
            <g key={shot.label}>
              ...
              {/* Label */}
              <text x={x + w/2} y={frameY + frameH + 14} textAnchor="middle" fontSize="11" fontWeight="700" fill="var(--green, #4A8C8C)" fontFamily="monospace">{shot.label}</text>
        ...
        <defs>
          <marker id="arrow" markerWidth="8" markerHeight="8" refX="6" refY="3" orient="auto">
            <path d="M0,0 L0,6 L8,3 z" fill="#4A8C8C"/>
          </marker>
        </defs>
        <line x1="18" y1="165" x2="682" y2="165" stroke="#4A8C8C" strokeWidth="1.5" markerEnd="url(#arrow)" opacity="0.5"/>
  ...
  return (
    <div style={{ background: '#fff', border: '1px solid var(--border)', borderRadius: '10px', padding: '20px', marginBottom: '20px' }}>
      ...
      <svg viewBox="0 0 580 200" xmlns="http://www.w3.org/2000/svg" style={{ width: '100%', height: 'auto', display: 'block' }}>
        ...
        {/* EYE LEVEL panel */}
        <rect x="205" y="10" width="170" height="150" rx="6" fill="#f0fbf4" stroke="#4A8C8C" strokeWidth="1.5"/>
        {/* Camera at same level */}
        <g transform="translate(290, 80)">
          <rect x="-12" y="-8" width="24" height="16" rx="3" fill="#4A8C8C" opacity="0.8"/>
          <circle cx="0" cy="0" r="5" fill="#1a3a0a"/>
          <line x1="12" y1="0" x2="45" y2="0" stroke="#4A8C8C" strokeWidth="1.5" strokeDasharray="3,2" opacity="0.7"/>
          <polygon points="45,0 38,-4 38,4" fill="#4A8C8C" opacity="0.7"/>
        </g>
        {/* Figure at same level */}
        <g transform="translate(222, 80)">
          <circle cx="0" cy="-22" r="12" fill="#4A8C8C" opacity="0.5"/>
          <rect x="-10" y="-9" width="20" height="50" rx="3" fill="#4A8C8C" opacity="0.35"/>
        </g>
        <text x="290" y="175" textAnchor="middle" fontSize="11" fontWeight="700" fill="#4A8C8C" fontFamily="monospace">EYE LEVEL</text>
    ...
    <div style={{ background: '#fff', border: '1px solid var(--border)', borderRadius: '10px', padding: '20px', marginBottom: '20px' }}>
      ...
      <svg viewBox="0 0 580 160" xmlns="http://www.w3.org/2000/svg" style={{ width: '100%', height: 'auto', display: 'block' }}>
        ...
        <g transform="translate(50, 20)">
          <rect x="0" y="0" width="200" height="120" rx="6" fill="#f0fbf4" stroke="#4A8C8C" strokeWidth="1.5"/>
          <line x1="0" y1="60" x2="200" y2="60" stroke="#4A8C8C" strokeWidth="0.5" strokeDasharray="4,4" opacity="0.4"/>
          <line x1="100" y1="0" x2="100" y2="120" stroke="#4A8C8C" strokeWidth="0.5" strokeDasharray="4,4" opacity="0.4"/>
          <g transform="translate(100, 60)">
            <circle cx="0" cy="-28" r="14" fill="#4A8C8C" opacity="0.45"/>
            <rect x="-12" y="-13" width="24" height="55" rx="3" fill="#4A8C8C" opacity="0.3"/>
          </g>
          <text x="100" y="138" textAnchor="middle" fontSize="10" fontWeight="700" fill="#4A8C8C" fontFamily="monospace">NORMAL FRAME</text>
