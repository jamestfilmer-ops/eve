...
const frameworks = [
  {
    ...
    best_for: 'Commercial films, thrillers, comedies, anything with a clear protagonist goal.',
  ...
  },
  {
    ...
    best_for: 'Epic stories, fantasy, sci-fi, any story about transformation or growth.',
  ...
  },
  {
    ...
    best_for: 'TV pilots, short stories, episodic work, anything character-driven.',
  ...
  },
  {
    ...
    beats: [],
    best_for: 'Literary fiction, experimental work, memoir, or when the story is still finding its form.',
...
export default function NewProject() {
  ...
  const [step, setStep] = useState(1) // 1 = pick framework, 2 = project details
              ...
              >
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '10px' }}>
                  ...
                  <div style={{
                    ...
                    {selected === f.id && <span style={{ color: '#fff', fontSize: '11px' }}>✓</span>}
                  </div>
                </div>
                <p style={{ fontSize: '14px', color: 'var(--text-mid)', lineHeight: '1.65', marginBottom: '12px' }}>{f.description}</p>
        ...
        <div className="fade-up" style={{ maxWidth: '560px' }}>
          <div className="card" style={{ padding: '28px', marginBottom: '24px' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '20px', paddingBottom: '16px', borderBottom: '1px solid var(--border)' }}>
              ...
              <button onClick={() => setStep(1)} style={{ marginLeft: 'auto', fontSize: '12px', color: 'var(--text-soft)', background: 'none', border: 'none', cursor: 'pointer', textDecoration: 'underline' }}>
                Change
              </button>
            </div>
