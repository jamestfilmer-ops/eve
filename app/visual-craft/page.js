...
export default function VisualCraftPage() {
  return (
    <div style={{ background: 'var(--off-white)', minHeight: '100vh' }}>
      ...
      {/* Hero */}
      <section style={{ background: 'var(--green)', padding: '88px 24px 72px' }}>
        ...
        <section style={{ marginBottom: '64px' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
            {featuredFilmmakers.map((person) => (
              <div key={person.name} style={{ background: '#fff', border: '1px solid var(--border)', borderRadius: '10px', padding: '20px 22px' }}>
