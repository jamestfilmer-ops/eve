...
const lessons = [
  ...
  },
  {
    ...
    items: [
      ...
      { title: 'Camera angles and power dynamics', slug: 'camera-angles', time: '10 min', level: 'Beginner', preview: 'Eye level, low angle, high angle, Dutch angle, bird-eye -- what each angle communicates about power, vulnerability, and psychological state.' },
